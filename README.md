...
progress/result/continuation loop завершены; документация двух репозиториев и analytics-петля
стабилизированы. Самостоятельный early-access мини-курс Python и его первый законченный урок
«Первая программа: ввод, вычисление и вывод» опубликованы и доступны из публичной навигации.
