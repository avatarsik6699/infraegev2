...
analytics-петля стабилизированы. Первый самостоятельный срез мини-курса Python и урок «Первая
программа: ввод, вычисление и вывод» находятся в review и не входят в публичную навигацию до
ручного одобрения.
