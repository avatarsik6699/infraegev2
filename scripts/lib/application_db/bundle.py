...
SCHEMA = "140_01"
# Bundles retain their exact verifier image, so the current maintenance tool can restore an
# additive predecessor without pretending that its verifier understands account records.
TASK_SCHEMAS = {"122_01", SCHEMA}
BASE_FILES = (
    "application.dump",
    "roles.sql",
    "data-checks.txt",
