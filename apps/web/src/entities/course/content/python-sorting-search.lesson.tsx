  ...
  theory: [
      ...
      explanation: (
        <>
          <Typography.Text>
            ...
            найденное значение можно сохранить. Такой последовательный просмотр
            называют линейным поиском: в худшем случае придётся проверить весь
            список.
          </Typography.Text>
          <CodeBlock
            code={
          ...
          <Typography.Text>
            ...
            настоящей записи. Позже внутри функции найденную запись можно будет
            сразу вернуть.
          </Typography.Text>
        </>
      ),
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            Сортировка упорядочивает элементы. Поэтому сначала решите, нужен ли
            дальше исходный порядок: от этого зависит выбор между функцией
            <Notation>sorted</Notation> и методом <Notation>sort</Notation>.
          </Typography.Text>
          <WorkedExample
    ...
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            Числа Python умеет сравнивать напрямую. Но у записи из нескольких
            полей нет одного очевидного порядка: дела можно расположить по
            названию, номеру или приоритету. Параметр <Notation>key</Notation>{" "}
            получает функцию, которая для каждой записи возвращает именно то
            значение, по которому нужно сравнивать.
          </Typography.Text>
          <CodeBlock
            code={
