  ...
  theory: [
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "В простом текстовом формате каждая строка описывает одну запись, а разделитель отделяет поля. После split получается список строковых значений; нужные столбцы выбирают по индексам и преобразуют."
            }
          </Typography.Text>
          <Typography.Text>
            {
              "Смысл индекса задаётся форматом файла. Если столбец балла третий, это должно быть известно до написания цикла, а не угадываться по конкретному примеру."
            }
          </Typography.Text>
          <CodeBlock
            code={
    ...
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "Обработка таблицы повторяет один конвейер для каждой строки: разделить, преобразовать, проверить условие и обновить результат. Каждая операция имеет своё место и не должна применяться ко всей строке сразу."
            }
          </Typography.Text>
          <Typography.Text>
            {
      ...
      explanation: (
        <>
          <Typography.Text>
            ...
            превратить в словарь и добавить в список. После этого сортировка,
            поиск и фильтрация работают с понятными именами полей, а не с
            загадочными индексами.
          </Typography.Text>
          <CodeBlock
            code={
    ...
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "Начните с одной строки и подпишите поля. Затем добавьте строку, которая проходит фильтр, и строку, которая его не проходит. Только после этого считайте сумму, количество или максимум."
            }
          </Typography.Text>
          <Procedure
