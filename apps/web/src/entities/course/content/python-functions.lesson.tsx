  ...
  theory: [
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "Функция объединяет несколько команд под понятным именем. Параметры обозначают данные, с которыми работает функция, а аргументы при вызове передают конкретные значения."
            }
          </Typography.Text>
          <Typography.Text>
            {
              "Тело функции выполняется только при вызове. Хорошее имя описывает результат или действие и позволяет читать основную программу без повторения деталей."
            }
          </Typography.Text>
          <CodeBlock
            code={
    ...
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "При вызове аргументы связываются с параметрами, затем выполняется тело. Команда return завершает вызов и подставляет результат туда, где находилось выражение вызова."
            }
          </Typography.Text>
          <Typography.Text>
            {
              "print и return решают разные задачи: print показывает значение человеку, return передаёт его следующей части программы."
            }
          </Typography.Text>
          <WorkedExample
    ...
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "Сначала сформулируйте контракт: какие значения функция получает и что возвращает. Затем подставьте маленькие аргументы и проследите только локальные переменные одного вызова."
            }
          </Typography.Text>
          <Procedure
