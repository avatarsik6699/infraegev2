  ...
  theory: [
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "Словарь хранит пары: по уникальному ключу можно получить связанное значение. Ключ описывает, что мы ищем, а значение содержит данные — например, имя ученика и его балл."
            }
          </Typography.Text>
          <Typography.Text>
            {
              "Присваивание по существующему ключу обновляет значение. Присваивание по новому ключу добавляет новую пару."
            }
          </Typography.Text>
          <CodeBlock
            code={
    ...
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "Выражение со скобками требует существования ключа. Если ключ может отсутствовать, сначала используют проверку in или метод get со значением по умолчанию."
            }
          </Typography.Text>
          <Typography.Text>
            {
              "Оператор in для словаря проверяет именно ключи. Чтобы работать со всеми значениями, используют values, а для пар — items."
            }
          </Typography.Text>
          <WorkedExample
    ...
    },
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            {
              "Прямое обращение по неизвестному ключу вызывает KeyError. Это не означает, что словарь сломан: программа просто не описала, что делать при отсутствии данных."
            }
          </Typography.Text>
          <Mistake
