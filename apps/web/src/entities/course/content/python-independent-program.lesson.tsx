  ...
  theory: [
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            Посмотрите, как далеко мы дошли без большого плана на сотню строк.
            Сначала программа научилась добавлять и показывать дела. Потом мы
            добавили изменение записей, а затем сохранение в файл. На каждом
            шаге появлялась одна понятная задача и несколько уже знакомых
            конструкций.
          </Typography.Text>
          <WorkedExample
      ...
      explanation: (
        <>
          <Typography.Text>
            ...
            <Notation>int(input())</Notation>. Исправим это в одном месте.
            Функция чтения либо вернёт целое число, либо объяснит ошибку и
            отдаст <Notation>None</Notation>, после чего меню продолжит работу.
          </Typography.Text>
          <CodeBlock
      ...
      explanation: (
        <>
          <Typography.Text>
            ...
            Сообщим, что файл не прочитан, и начнём с пустого списка. При этом
            не используем голый <Notation>except</Notation>: настоящие ошибки в
    ...
    },
    {
      ...
      explanation: (
        <>
          ...
          <Typography.Text>
            Не переписывайте всю программу ради красоты. Измените одну небольшую
            часть и снова пройдите тот же сценарий. Если результат не изменился,
            уборка кода была безопасной.
          </Typography.Text>
        </>
      ),
    },
