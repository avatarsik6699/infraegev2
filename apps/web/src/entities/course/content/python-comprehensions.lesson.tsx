  ...
  theory: [
    {
      ...
      explanation: (
        <>
          <Typography.Text>
            Включение не вводит новый способ мышления. Оно коротко записывает
            знакомую схему: создать коллекцию, пройти исходные значения и
            добавить преобразованный результат.
          </Typography.Text>
          <CodeBlock
            code={
          ...
          />
          <Typography.Text>
            Читать короткую запись удобно справа налево по смыслу: берём
            <Notation>number</Notation> из <Notation>range</Notation>, вычисляем
            его квадрат и помещаем результат в новый список.
          </Typography.Text>
        </>
      ),
    },
      ...
      explanation: (
        <>
          <Typography.Text>
            ...
            словарь. Выбирайте форму по требуемому результату, а не ради
            краткости.
          </Typography.Text>
          <CodeBlock
            code={
