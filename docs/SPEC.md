...
|-----------------|------------------------------------------|
| 2 проверенные проблемные темы ЕГЭ как публичный MVP baseline; дальнейшее расширение каталога относится к следующему продуктовому этапу | Аккаунты и синхронизация прогресса между устройствами |
...
| `22` | Вернуть public identity infraege и переработать главную по утверждённым референсам | In progress: Change 95 меняет знак, public metadata/header и только `/`; typography и внутренние learning layouts остаются прежними |
