...
`theme → semantic → component`, текущие иконки и правила языка контента; она не переносит к себе
демонстрации компонентов или widgets и не является черновиком реального урока. Внутри каждой
