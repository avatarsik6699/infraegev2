...
задач. Все 28 уроков локально опубликованы для финальной содержательной и визуальной оценки;
курс имеет stage `complete`.
...
| `M3` — учебный flow и публичный запуск | in progress | Завершить доменную логику, основные поверхности сайта и проверенный MVP-контент до расширения каталога | Два TopicLesson и все 28 Python CourseLesson локально опубликованы для финальной оценки без Topic-связей; внешний release остаётся отдельным шагом |
...
| `13` | Пересмотреть, углубить и опубликовать программу мини-курса Python одним change | In progress: все 28 уроков и 140 server-owned задач опубликованы локально для финальной оценки, включая четыре последовательных стадии менеджера задач; commit, push и deploy не выполнялись |
