...
Текущая runtime/infra cleanup: [Change 108](../changes/108-runtime-hygiene.md).
...
| 3. Оставшаяся runtime/infra hygiene | P2/P3, [Change 108](../changes/108-runtime-hygiene.md) | C02, оставшаяся часть C03, повторно проверенные C04, A01/A02. Проверять актуальный diff после DS, а не старые численные списки | Web/auxiliary states не изменили нужное поведение, живые tokens/mounts сохранены; узкий gate и cleanup allowlist |
