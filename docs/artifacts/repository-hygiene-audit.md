...
Реализация и актуальные результаты приёмки ведутся в [Change 107](../changes/archive/107-frontend-design-system-consolidation.md).
...
Change 107 завершён и архивирован локально. Следующие пакеты ниже — последовательные будущие
